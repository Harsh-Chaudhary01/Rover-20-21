...
entered_arr_lat_sub = rospy.Subscriber('/Entered_arr_lat_topic', Float64MultiArray, fnc1)
entered_arr_long_sub = rospy.Subscriber('/Entered_arr_long_topic', Float64MultiArray,fnc2)	
entered_n_sub = rospy.Subscriber('/Entered_n_topic', Float32, fnc3)
